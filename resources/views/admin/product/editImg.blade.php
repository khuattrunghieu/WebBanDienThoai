...
@section('content')
    @foreach ($product_img as $key => $product_img)
        <form action="{{ route('admin.product.storeImg', $product_img->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name='name' value="{{ $product->name }}" id="html5-text-input" disabled />
                                </div>
                            </div>
                        </div>
                    </div>
