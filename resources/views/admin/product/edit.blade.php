                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->processor }}" name='processor'
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->cpu }}" name='cpu'
                                    id="html5-number-input" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->gpu }}" name='gpu'
                                    id="html5-number-input" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->operating_system }}" name='operating_system'
                                    id="html5-number-input" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->ram }}" name='ram'
                                    id="html5-number-input" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $product->rom }}" name='rom'
                                    id="html5-number-input" />
                            </div>
                        </div>

                        <h5 class="card-header"><mark>Màn hình</mark></h5>
                        <textarea id="screen" name="screen">{{ $product->screen }}</textarea>
                        <script>
                            ClassicEditor
                        ...
                        <textarea id="r_camera" name="r_camera">{{ $product->r_camera }}</textarea>
                        <script>
                            ClassicEditor
                        ...
                        <textarea id="f_camera" name="f_camera">{{ $product->f_camera }}</textarea>
                        <script>
                            ClassicEditor
                        ...
                        <textarea id="connect" name="connect">{{ $product->connect }}</textarea>
                        <script>
                            ClassicEditor
                        ...
                        <textarea id="battery_charger" name="battery_charger">{{ $product->battery_charger }}</textarea>
                        <script>
                            ClassicEditor
                        ...
                        <textarea id="general" name="general">{{ $product->general }}</textarea>
                        <script>
                            ClassicEditor
